...
import { highligthedStateTrigger, shownStateTrigger, checkButtonTrigger } from '../animations';

@Component({
  selector: 'app-lista-tarefas',
  templateUrl: './lista-tarefas.component.html',
  styleUrls: ['./lista-tarefas.component.css'],
  animations: [highligthedStateTrigger, shownStateTrigger, checkButtonTrigger]
})
